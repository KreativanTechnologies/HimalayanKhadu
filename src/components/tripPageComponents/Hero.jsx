    ...
    return (
        <>
            <div className='responsivewidth mt-10 font-poppins'>
                <img src="/images/tripimg/triphero.png" alt="" className='min-h-[260px]'/>
                        ...
                        tours.map((item) => (
                            <>
                                <div key={item.id} className='flex flex-col gap-2'>
                                    ...
                                    <button className='px-[3.3vh] py-[2vh] w-32 bg-[#0C8699] text-white rounded-full text-sm '>Book Now!</button>
                                </div>
